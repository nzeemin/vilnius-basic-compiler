...
void Validator::ValidateIf(StatementModel& statement)
{
    ...
    if (statement.stthen == nullptr)
    {
        ...
        int linenum1 = ConstToInteger(param1.dvalue);
    ...
    else
    {
        ...
        if (keyword == KeywordFOR || keyword == KeywordNEXT || keyword == KeywordDIM || keyword == KeywordDATA)
    ...
    if (statement.stelse == nullptr)
    {
        if (statement.params.size() > 1)
        {
            ...
            int linenum2 = ConstToInteger(param2.dvalue);
